...
RUNTIME_ROOT=${CQAIP_RUNTIME_ROOT:-$ROOT}
...
export HF_HOME="$RUNTIME_ROOT/.runtime/huggingface"
export TORCH_HOME="$RUNTIME_ROOT/.runtime/torch"
export XDG_CACHE_HOME="$RUNTIME_ROOT/.runtime/cache"
export TMPDIR="$RUNTIME_ROOT/.runtime/tmp"
export TRITON_CACHE_DIR="$RUNTIME_ROOT/.runtime/triton"
export CUDA_CACHE_PATH="$RUNTIME_ROOT/.runtime/cuda"
export MPLCONFIGDIR="$RUNTIME_ROOT/.runtime/matplotlib"
export ALIPPU_CONFIG_PATH="$RUNTIME_ROOT/.runtime/ppu"
export HGRTC_CACHE_PATH="$RUNTIME_ROOT/.runtime/ppu/hgrtc"
