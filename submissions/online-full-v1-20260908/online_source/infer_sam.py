...
def main():
    ...
    status=ROOT/'candidate_online_20260908/sam_inference_status.json'
    ...
    for name in ['adamw','sgd_momentum']:
        ...
        out=ROOT/'candidate_online_20260908/sam_holdout'/name;out.mkdir(parents=True,exist_ok=True)
...
if __name__=='__main__':
    try:main()
    except Exception as e:dump(ROOT/'candidate_online_20260908/sam_inference_status.json',{'status':'failed','error_type':type(e).__name__,'time':time.time()});raise
